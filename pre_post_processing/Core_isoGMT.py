...
#                        ALL RIGHTS RESERVED
#=====================================================================
'''Core_isoGMT.py does everything Core_GMT.py does but runs in the isolated, 'isogmt' module instead of 'gmt' '''
#=====================================================================
#=====================================================================
...
def get_T_from_minmax(xyz_filename) :
    ...
    cmd = 'isogmt minmax -C %(xyz_filename)s' % vars()
...
def get_T_from_grdinfo(grid_filename):
    ...
    cmd = 'isogmt grdinfo -C %(grid_filename)s' % vars()
    s = subprocess.check_output( cmd, shell=True, universal_newlines=True)
    if verbose: print( Core_Util.now(), cmd )
    l = s.split()
    min = float(l[5])
